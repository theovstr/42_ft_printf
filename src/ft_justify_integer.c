...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/07 00:58:38 by theveste          #+#    #+#             */
/*   Updated: 2023/12/07 01:17:31 by theveste         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// if code not work, put back need in the justify_putflags_zero2
int	need(int i, t_flags *flags, int len, int v)
{
	int	ret;
